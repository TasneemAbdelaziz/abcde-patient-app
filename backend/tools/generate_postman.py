...
BODIES = {
    ...
    "POST consents/{id}/respond": {"decision": "given", "responded_by": "Mariam Abdel-Rahman (decision-maker)"},
    ...
    "POST patients/{serial}/family": {"companion_name": "Mariam Abdel-Rahman", "relation": "daughter", "companion_phone": "010-0000-0003", "can_see_status": True, "receives_alerts": True, "can_book": True, "can_rate": True, "can_raise_emergency": True, "is_decision_maker": True},
